...
describe("Form", () => {
  ...
  it("renders without student name if not provided", () => {
    const { getByPlaceholderText } = render(<Form dailyInterviewers={interviewers} />);
    expect(getByPlaceholderText("Enter Student Name")).toHaveValue("");
  });

  it("renders with initial student name", () => {
    const { getByTestId } = render(<Form dailyInterviewers={interviewers} student="Lydia Miller-Jones"/>);
  ...
  it("validates that the interviewer cannot be null", () => {
    ...
    const { getByText } = render(
      <Form dailyInterviewers={interviewers} onSave={onSave} student="Lydia Miller-Jones" />
    );
